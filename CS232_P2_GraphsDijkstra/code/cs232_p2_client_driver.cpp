////////////////////////////////////////////////////////////////////////////////////////////////
//
// File name         : cs232_p2_client_driver.cpp
//
...
int main() {
	...
	do {
		...
		case 'J': {//performs shortest distance dijkstra algorithm
			//mainGraph.ShortestDistance();
			cout << "this feature isn't working properly at this time" << endl;
			cclear();
			break; }
